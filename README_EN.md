...
[![Stars](https://img.shields.io/github/stars/mracry/sub2api?style=social)](https://github.com/mracry/sub2api)


**This is mracry's unofficial Sub2API mod, not the tosky / ranxi2001 original.**

Forked from [ranxi2001/sub2api](https://github.com/ranxi2001/sub2api) / [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api).  
Maintained by [mracry](https://github.com/mracry). **No PRs to upstream. No upstream WeChat group, docs site, or releases.**

**Shared free of charge.** If it helps, please star the repo:  
→ [https://github.com/mracry/sub2api](https://github.com/mracry/sub2api)

[Repository](https://github.com/mracry/sub2api) · [Mod branch](https://github.com/mracry/sub2api/tree/feat/codex-harvest-flow-admin) · [Ticket stickiness](CODEX门票钉住原理.md)
...
An unpaid unofficial mod, not an official release. No WeChat group, no QR code, no tosky docs, no ranxi Release. If it helps, [star it on GitHub](https://github.com/mracry/sub2api).

- Do not install this mod with `ranxi2001/sub2api` scripts, images, or update channels.
- Do not open PRs against upstream.
- Codex ticket behavior differs: conversations must stick to the harvest egress and identity. See [CODEX门票钉住原理.md](CODEX门票钉住原理.md).
...
**This mod is shared free of charge. If it helps, please [star it on GitHub](https://github.com/mracry/sub2api).**
