...
**これは mracry の非公式 Sub2API 魔改版です。tosky / ranxi2001 の原版ではありません。**

無償公開です。役に立ったら GitHub で Star をお願いします：  
→ [https://github.com/mracry/sub2api](https://github.com/mracry/sub2api)

[リポジトリ](https://github.com/mracry/sub2api) · [チケット固定の説明](CODEX门票钉住原理.md)
...
無償公開の魔改版であり、公式リリースではありません。WeChat グループ、QR、tosky ドキュメント、ranxi Release はありません。役に立ったら [GitHub で Star](https://github.com/mracry/sub2api) をお願いします。
...
**本魔改は無償公開です。役に立ったら [GitHub で Star](https://github.com/mracry/sub2api) をお願いします。**
